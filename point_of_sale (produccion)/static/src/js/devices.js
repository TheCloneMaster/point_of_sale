    ...
    module.BarcodeReader = instance.web.Class.extend({
        ...
        scan: function(code){
            ...
            if(code.length < 3){
                ...
                console.error('***************   scan - UPC-A - devices.js  ******************');
                ...
                console.error('***************   scan - reference - devices.js  ******************');
            }else{
                var parse_result = {
                    encoding: 'error',
                    type: 'error',
                ...
                console.error('***************   scan - error - devices.js  ******************');
            }

            if(parse_result.type in {'product':'', 'weight':'', 'price':''}){    //ean is associated to a product
                console.error('***************   scan - step 1 - devices.js  ******************');
                if(this.action_callback['product']){
                    console.error('***************   scan - step 1.1 - devices.js  ******************');
                    this.action_callback['product'](parse_result);
                    console.error('***************   scan - step 1.2 - devices.js  ******************');
                }
            }else{
                console.error('***************   scan - step 2 - devices.js  ******************');
                if(this.action_callback[parse_result.type]){
                    console.error('***************   scan - step 2.1 - devices.js  ******************');
                    this.action_callback[parse_result.type](parse_result);
                    console.error('***************   scan - step 2.2 - devices.js  ******************');
                }
            }
        },
